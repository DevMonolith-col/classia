  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`transition-all duration-300 lg:pt-0 pt-16 ${isCollapsed ? "lg:pl-16" : "lg:pl-64"}`}>
        {impersonating && (
          <div
            className={`sticky top-16 z-20 flex items-center justify-between px-6 py-2.5 shadow-md lg:top-0 lg:z-30 ${
        ...
        {/* La barra superior móvil es `fixed h-16` y este contenedor la compensa con
            `pt-16`, así que `min-h-screen` acá sumaba 100vh + 64px y dejaba 64px de
            scroll vertical fantasma en todas las rutas por debajo de `lg`. Mismo
            `calc(100vh-4rem)` que ya usan soporte/layout.tsx y messaging-panel.tsx. */}
