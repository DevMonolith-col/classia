...
import { SubmissionsWorkbench } from "@/components/profesor/submissions-workbench"
import type { Homework } from "@/components/profesor/homework-types"

export default function EntregasAsignacionPage() {
  ...
  return <SubmissionsWorkbench homework={homework} />
}
