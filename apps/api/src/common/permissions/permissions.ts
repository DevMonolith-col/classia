...
export const PERMISSIONS = {
  ...
  ELECTIONS_MANAGE: "elections:manage", // crear, agregar candidatos, cambiar estado, ver escrutinio
  ELECTIONS_MONITOR: "elections:monitor", // ver participación (ElectionVoter), nunca el escrutinio
...
const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  TEACHER: [
    ...
    PERMISSIONS.ANNOUNCEMENTS_CREATE,
    PERMISSIONS.ANNOUNCEMENTS_DELETE,
    // Calendario: crear/editar/borrar está acotado por EventsService a los grupos que
    // enseña y a los eventos que él creó. El permiso abre la ruta; el alcance por fila no
    // es expresable en un decorador. Mismo reparto que ANNOUNCEMENTS_CREATE/DELETE arriba.
    PERMISSIONS.EVENTS_LIST,
    PERMISSIONS.EVENTS_READ,
    PERMISSIONS.EVENTS_CREATE,
    PERMISSIONS.EVENTS_UPDATE,
  ...
  GUARDIAN: [
    ...
    PERMISSIONS.ANNOUNCEMENTS_LIST,
    PERMISSIONS.ANNOUNCEMENTS_READ,
    // Solo lectura: el calendario escolar que las familias no podían ver hasta ahora.
    PERMISSIONS.EVENTS_LIST,
    PERMISSIONS.EVENTS_READ,
  ...
  // Lidera el equipo de soporte (asigna tickets, otorga acceso a un colegio)
  // sin el poder total de la plataforma que tiene SUPER_ADMIN: mismo alcance
  // de lectura que un agente, más las acciones de supervisión del módulo de
  // soporte (gateadas por rol directamente en ese módulo, no por permiso).
  SUPPORT_SUPERVISOR: [
    PERMISSIONS.TENANTS_LIST,
    PERMISSIONS.TENANTS_READ,
    PERMISSIONS.GROUPS_LIST,
