...
const TENANT_B_SLUG = "events-e2e-tenant-b";

const ADMIN_A_EMAIL = "events-e2e-admin-a@classia.test";
const TEACHER_1_EMAIL = "events-e2e-teacher-1@classia.test";
const TEACHER_2_EMAIL = "events-e2e-teacher-2@classia.test";
const GUARDIAN_EMAIL = "events-e2e-guardian@classia.test";
const ADMIN_B_EMAIL = "events-e2e-admin-b@classia.test";
